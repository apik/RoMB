  ...
  try
    {
      ...
      */
      /*
        RoMB_loop_by_loop pent(lst(k1),lst(-pow(p1 + k1,2)+ ms,-pow(p1 + p5 + k1,2)+ms,
      ...
      */
      ...
      RoMB_loop_by_loop pent(lst(k1),lst(-pow(p1 + k1,2),-pow(p1 + p5 + k1,2),
                                         -pow(p1 + p5 + p4 + k1,2),-pow(p1 + p5 + p4 + p3 + k1,2),
                                         -pow(k1,2)),
                             lst(
                                 p1*p1 == 0, 
                                 //                                   p2*p2 == 0, 
